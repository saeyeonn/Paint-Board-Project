...
public class FontType {
    ...
    private static void applySelectedAttributes() {
        ...
        if (selectedTextField != null) {
            TextState FontStates = statesMap.get(selectedTextField);
    ...
    private static void storeFontType(JTextField textField) {
        if (textField != null && fontComboBoxForm != null) {
            TextState FontStates = statesMap.get(textField);
            if (FontStates == null) {
                FontStates= new TextState();
    ...
    private static void loadFontType() {
        if (selectedTextField != null) {
            TextState fontState = statesMap.get(selectedTextField);
            if (fontState != null) { // null 체크 추가
                fontComboBoxForm.setSelectedItem(fontState.getFontName());
            }
        }
    }
}
