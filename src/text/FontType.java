...
public class FontType {
    ...
    static void textCilcked(JTextField textField) {
        ...
        if (!FontStatesMap.containsKey(textField)) {
            FontStatesMap.put(textField, new TextStates());
        }
    }
    ...
    private static void applySelectedAttributes() {
        ...
        if (selectedTextField != null) {
            TextStates FontStates = FontStatesMap.get(selectedTextField);
    ...
    private static void storeFontType(JTextField textField) {
        if (textField != null && fontComboBoxForm != null) {
            TextStates FontStates = FontStatesMap.get(textField);
            if (FontStates == null) {
                FontStates= new TextStates();
                FontStatesMap.put(textField, FontStates);
            }
